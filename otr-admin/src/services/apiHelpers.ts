...
export function GetCategories() {
  return server.get(endpoints.getCategories, { requiresAuth: false });
}
...
// ✅ apiHelpers.ts
export function CreateQuestionPaper(jobPostId: number, data: any) {
  return server.post(`api/question-paper/create?jobPostId=${jobPostId}`, data, { requiresAuth: false });
}
...
export function ReleaseExamAPI(id:any) {
  return server.post(endpoints.examRelease+id, { requiresAuth: false });
}
